...
This privacy policy applies to the Social Media Downloader app (hereby referred to as "Application") for mobile devices that was created by Android Byte Sensei (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
...
For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to mobilebytesensei@gmail.com. The information that the Service Provider request will be retained by them and used as described in this privacy policy.
